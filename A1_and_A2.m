...
for i=1:count
    ...
    for k=1:count
        A2 = R2.*exp(1i*deg2rad(range_a2(k)));
...
surf(range_a1, range_a2, abs(result_AKF), 'MeshStyle','column','LineWidth',0.1,'EdgeAlpha',0.2);
zlabel('Значение бокового пика','FontSize',14);
ylabel('Угол фазы коэффциента a_2','FontSize',14);
xlabel('Угол фазы коэффциента a_1','FontSize',14);
...
surf(range_a1, range_a2, abs(result_VKF), 'MeshStyle','column','LineWidth',0.1,'EdgeAlpha',0.2);
zlabel('Значение бокового пика','FontSize',14);
ylabel('Угол фазы коэффциента a_2','FontSize',14);
xlabel('Угол фазы коэффциента a_1','FontSize',14);
title('Зависимость бокового пика АКФ от углов фаз a_1 и a_2','FontSize',16);
